...
const EmailList = () => {
  ...
  const getEmails = async() => {
    const response = await axios.get('https://sushil1204.github.io/db.json');
  ...
  return (
    <section className="w-full">
      {emails && emails.map((email)=>(
        <>
      <div className="flex gap-4 border-2 border-solid border-[#CFD2DC] mb-4 hover:cursor-pointer hover:border-[#E54065]" key={email.id}>
